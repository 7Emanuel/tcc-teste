...
import { initDb, prisma } from '../server/db.js';
import adminRouter from '../server/admin.js';
import { registerUser, loginUser, getUserFromToken } from '../server/auth.js';
...
const dataDir = '/tmp/data'; // Use /tmp for Vercel
...
// Public endpoint: check beneficiary status by email
